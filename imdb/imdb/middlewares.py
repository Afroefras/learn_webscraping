...
class UserAgentRotatorMiddleware(UserAgentMiddleware):
    ...
    def process_request(self, request, spider):
        try:
            self.user_agent = random.choice(self.users_list)
            request.headers.set_default('User-Agent',self.user_agent)
        except IndexError:
            logging.error(f'Could not fetch the user agent: {self.user_agent}')
